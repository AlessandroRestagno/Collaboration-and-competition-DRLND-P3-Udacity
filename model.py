...
class ActorModel(nn.Module):
    ...
    def __init__(self, input_size, output_size, seed, fc1_units=256, fc2_units=128, fc3_units=64, fc4_units=32):
        ...
        self.fc5= nn.Linear(fc4_units, output_size)
...
class AC_Models():
    """
    objects that creates the models required per DDPG agent
    """
